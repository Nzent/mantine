...
Package depends on `@mantine/dates` and `dayjs`.
...
<Demo data={DatePickerDemos.usage} demoProps={{ zIndex: 5 }} />
...
<Demo data={DatePickerDemos.noLevel} demoProps={{ zIndex: 5 }} />
...
<Demo data={DatePickerDemos.notClearable} demoProps={{ zIndex: 5 }} />
...
<Demo data={DatePickerDemos.flip} />
